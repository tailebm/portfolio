...
const Portfolio = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            link: "/images/dgah/Rapport_2023_TAILEB.pdf",
            imgLink: "/images/dgah/dgah.jpg",
        },
        {
            id: 11,
        ...
        {
            id: 10,
            title: "APPLICATION WEB - RefApp",
            category: "filter-web",
            date: "2025",
            image: "/images/refapp/refapp.png",
            description: "Réalisation d'une application web de référencement des applications du ministère de l'Intérieur.",
            languages: "Logiciels : Symfony, VirtualBox, PhpMyAdmin",
            link: "https://github.com/dnum-mi/referentiel-applications",
            imgLink: "/images/refapp/refapp.png",
        },
    ];
