                ...
                <div className="resume-cards">
                    <div className="resume-card" data-aos="fade-left">
                        ...
                        <div className="resume-text">
                            ...
                            <ul>
                                <li><b>Analyse des besoins :</b> Recueil des besoins auprès de la SDAS pour formaliser les spécifications fonctionnelles et techniques.</li>
                            ...
                            <div className="valo">
                                <a href="/images/Rapport_2023_TAILEB.pdf" target="_blank" rel="noopener noreferrer">
                                    <p><span className="bg"></span><span className="base"></span><span className="text">Rapport d'Alternance</span></p>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="resume-card" data-aos="fade-left">
                        ...
                        <div className="resume-text">
                            ...
                            <ul>
                                <li><b>Analyse des besoins :</b> Recueil des besoins auprès du PO de la SDID pour formaliser les spécifications fonctionnelles et techniques dans un cadre Agile.</li>
                            ...
                            <div className="valo">
                                <a href="/images/Rapport_2025_TAILEB.pdf" target="_blank" rel="noopener noreferrer">
                                    <p><span className="bg"></span><span className="base"></span><span className="text">Rapport d'Alternance</span></p>
                                </a>
                            </div>
                        </div>
